...
public sealed class SetConfigCommand : ConfigGroupBase, IIdempotentCommand<Unit>
{
  ...
  public sealed class Handler : IIdempotentCommandHandler<SetConfigCommand, Unit>
  {
