...
string[] testFiles = [
  ...
  Path.Combine(testsDir, "TimeWarp.Nuru.Tests/Parsing/Parser/parser-11-end-of-options.cs"),
  Path.Combine(testsDir, "TimeWarp.Nuru.Tests/Parsing/Parser/parser-12-specificity-ranking.cs"),
  Path.Combine(testsDir, "TimeWarp.Nuru.Tests/Parsing/Parser/parser-14-complex-integration.cs"),
  Path.Combine(testsDir, "TimeWarp.Nuru.Tests/Parsing/Parser/parser-15-error-reporting.cs"),
