...
public class OptionMatchingTests
{
  ...
  public static async Task Should_match_required_option_build_config_debug()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      ...
      .WithHandler((string mode) => { boundMode = mode; return 0; })
      .AsCommand()
      .Done()
      .Build();
  ...
  public static async Task Should_match_boolean_flag_build_verbose_true()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("build --verbose")
      .WithHandler((bool verbose) => { boundVerbose = verbose; return 0; })
      .AsCommand()
      .Done()
      .Build();
  ...
  public static async Task Should_match_typed_option_server_port_8080()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      ...
      .WithHandler((int num) => { boundNum = num; return 0; })
      .AsCommand()
      .Done()
      .Build();
...
#pragma warning disable RCS1163 // Unused parameter
    NuruCoreApp app = new NuruAppBuilder()
      ...
      .WithHandler((string source, string? file) => { boundFile = file; return 0; })
      .AsCommand()
      .Done()
