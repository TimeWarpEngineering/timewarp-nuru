...
// ============================================================================
// FLUENT DSL - Shell Tab Completion
// ============================================================================
// This runfile demonstrates shell tab completion with Fluent DSL.
//
// DSL: Fluent API with .EnableCompletion()
//
// Usage:
//   1. Run with --help:           dotnet run fluent-completion.cs -- --help
//   2. Interactive REPL:          dotnet run fluent-completion.cs -- -i
//   3. Generate shell completion: dotnet run fluent-completion.cs -- --generate-completion bash
//   4. Test __complete callback:  dotnet run fluent-completion.cs -- __complete 1 deploy
//
// ============================================================================
