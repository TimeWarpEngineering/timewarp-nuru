...
- [ ] Source generate `__complete` route handler in `CompletionEmitter`
- [ ] Source generate `--generate-completion` route
- [ ] Source generate `--install-completion` route
...
└── InterceptorEmitter - sets app.ShellCompletionProvider
