...
/// <summary>
/// Locates .AddBehavior(...) calls that register pipeline behaviors.
/// </summary>
internal static class AddBehaviorLocator
{
  private const string MethodName = "AddBehavior";
