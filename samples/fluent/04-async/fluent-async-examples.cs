...
#pragma warning disable NURU_H002 // Closures in handlers - intentional for demo

// ═══════════════════════════════════════════════════════════════════════════════
// FLUENT DSL - ASYNC HANDLER EXAMPLES
// ═══════════════════════════════════════════════════════════════════════════════
//
// This sample demonstrates async/await patterns using Fluent DSL:
//
// - Simple async handlers (Task return)
// - Async with parameters (required and optional)
// - Async returning values (Task<int> for exit codes)
...
//
// All handlers in TimeWarp.Nuru support async/await natively - no special
// configuration needed. The source generator correctly handles:
//   - async () => { }           → Task
//   - async (params) => { }     → Task  
//   - async (params) => value   → Task<T>
//
// ═══════════════════════════════════════════════════════════════════════════════
...
// Async route returning Task<int> - value becomes exit code
...
// Async route with cancellation support
...
// Async route with multiple optional options
...
builder.Map("--help")
  .WithHandler(() =>
  {
    Console.WriteLine("Async Examples for TimeWarp.Nuru - Fluent DSL");
    Console.WriteLine("==============================================");
