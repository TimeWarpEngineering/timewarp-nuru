...
// ═══════════════════════════════════════════════════════════════════════════════
// FLUENT DSL - COMPLETE PIPELINE MIDDLEWARE
// ═══════════════════════════════════════════════════════════════════════════════
//
// This sample demonstrates ALL pipeline behavior patterns using Fluent DSL:
//
...
//
// DSL: Fluent API with .AddBehavior() and .Implements<T>()
//
// RUN THIS SAMPLE:
//   ./fluent-pipeline-combined.cs echo "Hello"      # Basic pipeline demo
//   ./fluent-pipeline-combined.cs slow 600            # Performance warning
//   ./fluent-pipeline-combined.cs admin delete-all    # Auth denied
//   CLI_AUTHORIZED=1 ./fluent-pipeline-combined.cs admin delete-all  # Auth granted
//   ./fluent-pipeline-combined.cs flaky 2             # Retry demo
//   ./fluent-pipeline-combined.cs error validation    # Exception handling
//   ./fluent-pipeline-combined.cs trace api-call      # Telemetry demo
// ═══════════════════════════════════════════════════════════════════════════════
...
NuruApp app = NuruApp.CreateBuilder()
  ...
  .AddBehavior(typeof(RetryBehavior))           // Filtered: only IRetryable routes
