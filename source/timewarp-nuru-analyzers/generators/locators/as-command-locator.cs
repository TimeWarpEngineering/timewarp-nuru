...
/// <summary>
/// Locates .AsCommand() calls that mark routes as commands.
/// </summary>
internal static class AsCommandLocator
{
  private const string MethodName = "AsCommand";
