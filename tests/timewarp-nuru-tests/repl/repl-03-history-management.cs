...
namespace TimeWarp.Nuru.Tests.ReplTests.HistoryManagement
{
  ...
  public static async Task Should_clear_history_removes_prior_commands()
  {
    ...
    NuruApp app = NuruApp.CreateBuilder()
      ...
      .Map("greet {name}")
        ...
        .AsCommand()
        .Done()
      .AddRepl(options => options.PersistHistory = false)
      .Build();
  ...
  public static async Task Should_respect_max_history_size()
  {
    ...
    NuruApp app = NuruApp.CreateBuilder()
      ...
      .Map("cmd3").WithHandler(() => "3").AsCommand().Done()
      .Map("cmd4").WithHandler(() => "4").AsCommand().Done()
      .Map("cmd5").WithHandler(() => "5").AsCommand().Done()
      .AddRepl(options => options.MaxHistorySize = 3)
      .Build();
