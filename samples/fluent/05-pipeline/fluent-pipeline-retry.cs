...
// ═══════════════════════════════════════════════════════════════════════════════
// FLUENT DSL - RETRY PIPELINE MIDDLEWARE
// ═══════════════════════════════════════════════════════════════════════════════
//
...
//
// RUN THIS SAMPLE:
//   ./fluent-pipeline-retry.cs flaky 0    # Succeeds immediately
//   ./fluent-pipeline-retry.cs flaky 2    # Fails twice, then succeeds
//   ./fluent-pipeline-retry.cs flaky 5    # Fails all retries (max 3)
//   ./fluent-pipeline-retry.cs echo Hello # No retry (doesn't implement IRetryable)
// ═══════════════════════════════════════════════════════════════════════════════
