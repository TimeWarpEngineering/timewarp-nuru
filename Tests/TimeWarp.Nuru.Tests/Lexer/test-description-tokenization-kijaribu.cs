...
public class DescriptionTokenizationTests
{
   ...
   * These tests for element-level descriptions (internal | usage) have been relocated
   * to the new advanced features test file for better organization.
   *
   * ANALYSIS BY CLAUDE (Roo): ✅ VERIFIED - Can be safely deleted
   * - All 3 test methods successfully migrated to lexer-15
   * - ParameterWithDescription: lexer-15 lines 13-35
   * - OptionWithDescription: lexer-15 lines 41-67
   * - ComplexPatternWithDescriptions: lexer-15 lines 73-109
   */
