...
// ═══════════════════════════════════════════════════════════════════════════════
// FLUENT DSL - CONSOLE LOGGING
// ═══════════════════════════════════════════════════════════════════════════════
//
// This sample demonstrates logging configuration with Fluent DSL.
//
// DSL: Fluent API with .ConfigureServices() and .AddBehavior()
//
// Key features shown:
...
//
// Run with: ./fluent-logging-console.cs test
//           ./fluent-logging-console.cs greet Alice
//
// ═══════════════════════════════════════════════════════════════════════════════
