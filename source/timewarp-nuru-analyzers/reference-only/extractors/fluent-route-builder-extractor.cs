...
/// </summary>
internal static class FluentRouteBuilderExtractor
{
  /// <summary>
  ...
  private static string ResolveClrType(string? typeConstraint)
  {
    return typeConstraint switch
    {
      ...
      _ when typeConstraint.StartsWith("global::", StringComparison.Ordinal) => typeConstraint,
      _ => string.Format(CultureInfo.InvariantCulture, "global::{0}", typeConstraint)
    };
  }
}
