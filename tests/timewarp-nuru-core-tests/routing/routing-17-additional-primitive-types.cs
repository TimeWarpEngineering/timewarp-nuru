...
public class AdditionalPrimitiveTypeTests
{
  ...
  public static async Task Should_bind_byte_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setbyte {value:byte}", (byte value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_sbyte_positive()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setsbyte {value:sbyte}", (sbyte value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_short_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setshort {value:short}", (short value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_ushort_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setushort {value:ushort}", (ushort value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_uint_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setuint {value:uint}", (uint value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_ulong_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setulong {value:ulong}", (ulong value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_float_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setfloat {value:float}", (float value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_char_parameter()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("setchar {value:char}", (char value) => { boundValue = value; return 0; })
      .Build();
  ...
  public static async Task Should_bind_byte_array_catch_all()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("bytes {*values:byte}", (byte[] values) => { boundValues = values; return 0; })
      .Build();
  ...
  public static async Task Should_bind_short_array_catch_all()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("shorts {*values:short}", (short[] values) => { boundValues = values; return 0; })
      .Build();
  ...
  public static async Task Should_bind_float_array_catch_all()
  {
    ...
    NuruCoreApp app = new NuruAppBuilder()
      .Map("floats {*values:float}", (float[] values) => { boundValues = values; return 0; })
      .Build();
